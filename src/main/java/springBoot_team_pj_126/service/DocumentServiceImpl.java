...
public class DocumentServiceImpl implements DocumentService{
	...
	@Override
	public void addVacationDocument(DocumentDTO dto) 
			throws ServletException, IOException {
		
		System.out.println("<<< 서비스 - 휴가좀 가자 제발  >>>");
		System.out.println(dto.getStartDate());
		System.out.println(dto.getEndDate());
		System.out.println(dto.getVacationDate());
		
		mapper.addVacationDocument(dto);		
	}
	...
	@Override
	public void updateVacationDocument(DocumentDTO dto) 
			throws ServletException, IOException {
		
		System.out.println("<<< 서비스 - 문서수정 >>> ");
		
		mapper.updateVacationDocument(dto);
	}
	...
	@Override
	public void vacationDeduction(DocumentDTO dto) 
			throws ServletException, IOException {

		mapper.vacationDeduction(dto);
	}


	@Override
	public void addVacationDate(DocumentDTO dto) 
			throws ServletException, IOException {
		
		mapper.addVacationDate(dto);
	}
